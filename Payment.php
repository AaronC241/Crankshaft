...
<div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
    <div class="w-full mx-auto rounded-lg item-center bg-white shadow-lg p-5 text-gray-700" style="max-width: 600px">
        <div class="mb-10">
        ...
        <div class="mb-3">
            ...
            <div>
                <input class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="Name" type="text"/>
            </div>
        </div>
        <div class="mb-3">
        ...
        <div>
            <button class="block w-full max-w-xs mx-auto bg-green-500 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"><i class="mdi mdi-lock-outline mr-1"></i> PAY NOW</button>
        </div>
    </div>
</div>
